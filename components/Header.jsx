...
const navigation = [
    ...
    { name: 'Information', href: '#', current: false, icon: faCircleInfo },
    { name: 'Ordinateurs', href: '#', current: false, icon: faComputer },
    { name: 'Créer un ordinateur', href: '#', current: false, icon: faScrewdriverWrench },
    { name: 'Composantes Individuels', href: '#', current: false, icon: faTableList },
  ]
              ...
              <div className="px-2 pt-2 pb-3 space-y-1">
                {navigation.map((item) => (
                  <Disclosure.Button
                    ...
                    href={item.href}
                    className={classNames(
                      item.current ? 'bg-green-dark text-white' : 'text-gray-300 hover:bg-green hover:text-white',
