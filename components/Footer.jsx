...
export default function Footer() {
    return (
        <footer className=" bg-green text-white w-full mt-4 p-4 space-y-2">
            ...
            <p>Appelez nous à <a className="gold-link" href="tel:5551239876">(555) 123-9876</a>, 
            nous sommes disponibles 9:00 à 17:00 tous les jours. <br />
            Vous pouvez aussi envoyez un courriel à <a className="gold-link" href="mailto:ti626@titech.com">ti626@titech.com</a>.</p>
        </footer>
    )
}